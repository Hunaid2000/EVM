...
public class AddNewCandidateScreenController {
    ...
    void SubmitButtonPressed(ActionEvent event) {
    	Candidate candidate = new Candidate(CandidateCNIC.getText(), CandidateName.getText(), PartyName.getText());
    	votingMachine.addNewCandidate(PartyName.getText(), candidate);
    }
